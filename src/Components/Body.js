...
export class Body extends React.Component {
    ...
    async display_movie_details(movie) {
        ...
        var movie = await API.get_one_movie(movie.id);
        this.setState({ style_popup: { display: "block" }, target_movie_data: movie })
    }
    popup_windows() {
                ...
                <div class="popup_content">
                    ...
                    <div className="popup_body">
                        ...
                        <div className="popup_paragraph">
                            <p className="popup_overview">Overviews: <br />{movie.overview}</p>
                            <p className="popup_info"> Genres: {genres_movie()}</p>
